...
public class TermsActivity extends BaseActivity implements ITermsPrivacyView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        termsPresenter.getTermsandPrivacy(1);
...
//        tvToolbar.setText(getResources().getString(R.string.terms_of_services));
